...
FreeBSD, Linux, and OpenBSD as root or a regular user. A copy is also kept in
**`contrib/`** for backward compatibility.

Full per-OS installation instructions (token setup, cron/systemd automation,
test runs) are in **[docs/upload-client.md](docs/upload-client.md)**.
